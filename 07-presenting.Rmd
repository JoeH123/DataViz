...
Here's another example.  The graph below is fine (though, it should probably be horizontal rather than vertical).  But, if you want to persuade people that beer is expensive at baseball games, this likely won't do it without a significant explanation from you.

|![](Berinato3.png)|
|:--:|
| <b> Image Credits - Scott Berinato (@Berinato_2016) </b>|

The image below is far more persuasive.  It very quickly demonstrates how expensive beer is at baseball games.  Admittedly, it is slightly over the top, but it does drive the point home.
